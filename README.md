...
![Query 2 Result](https://github.com/user-attachments/assets/88b6a9a6-3899-4274-8e44-3cdac35c599b)
...
![Query 3 Result](https://github.com/user-attachments/assets/ff92e448-48de-466a-a2fc-f87f59b1e22a)
...
WHERE
    A.APPOINTMENT_ID NOT IN (SELECT APPOINTMENT_ID FROM TREATMENTS)
    AND A.STATUS = 'Scheduled';
```
**Result:**

![Query 4 Result](https://github.com/user-attachments/assets/7dbb61c8-95f8-43ea-9ffd-9889381fa6d2)
...
![Query 5 Result](https://github.com/user-attachments/assets/01d92842-a8e3-431e-b8b7-cbce29b197ef)
...
![Query 6 Result](https://github.com/user-attachments/assets/af7bf31e-e730-4f30-9f25-9932419a71ab)
